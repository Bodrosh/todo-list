...
<template>
    ...
    >
        <div v-if="canLogin" class="sm:tw-fixed sm:tw-top-0 sm:tw-right-0 tw-p-6 text-end">
            <Link
            ...
            <template v-else>
                ...
                <Link
                    v-if="canRegister"
                    :href="route('register')"
                    class="ms-4 tw-font-semibold tw-text-gray-600 hover:tw-text-gray-900 dark:tw-text-gray-400 dark:hover:tw-text-white focus:outline focus:outline-2 focus:tw-rounded-sm focus:outline-red-500"
                >Register</Link>
            </template>
        </div>
        ...
        <div class="tw-max-w-7xl tw-mx-auto tw-p-6 lg:tw-p-8">
                ...
                <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6 lg:tw-gap-8">
                    ...
                    >
                        <div>
                            ...
                            <h2 class="tw-mt-6 tw-text-xl tw-font-semibold tw-text-gray-900 dark:tw-text-white">Список задач</h2>

                            <p class="tw-mt-4 tw-text-gray-500 dark:tw-text-gray-400 tw-text-sm tw-leading-relaxed">
                                Управляйте вашими задачами - создавайте их, отмечайте как "выполненные", удаляйте неактуальные.
                            </p>
                        </div>
            ...
            <div class="tw-flex tw-justify-center tw-mt-16 tw-px-6 sm:tw-items-center sm:tw-justify-between">
                <div class="tw-text-center tw-text-sm tw-text-gray-500 dark:tw-text-gray-400 sm:text-start">
                    <div class="tw-flex tw-items-center tw-gap-4">
                        ...
                        >
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                stroke-width="1.5"
                                class="tw--mt-px me-1 tw-w-5 tw-h-5 stroke-gray-400 dark:stroke-gray-600 group-hover:stroke-gray-600 dark:group-hover:stroke-gray-400"
                            >
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                ...
                <div class="ms-4 tw-text-center tw-text-sm tw-text-gray-500 dark:tw-text-gray-400 sm:text-end sm:ms-0">
