            ...
            <nav class="tw-bg-white tw-border-b tw-border-gray-100">
                    ...
                    <div class="tw-flex tw-justify-between tw-h-16">
                        <div class="tw-flex">
                            ...
                            <div class="tw-hidden tw-space-x-8 sm:tw--my-px sm:ms-10 sm:tw-flex">
                                <NavLink :href="route('task.index')" :active="route().current('todo.index')">
                                    Dashboard
                                </NavLink>
                            </div>
                        </div>
                                    ...
                                    <template #trigger>
                                        <span class="tw-inline-flex tw-rounded-md">
                                            ...
                                            >
                                                ...
                                                <svg
                                                    class="ms-2 -me-0.5 tw-h-4 tw-w-4"
                ...
                >
                    <div class="tw-pt-2 tw-pb-3 tw-space-y-1">
                        <ResponsiveNavLink :href="route('task.index')" :active="route().current('todo.index')">
                            Dashboard
                        </ResponsiveNavLink>
                    </div>
